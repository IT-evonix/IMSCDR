      ...
      <div className="overview_main">
        <div className="overview_inner">
          <div className="overview_left">
            ...
            <p className="m-0">
              The Bachelor of Computer Applications (BCA) at IMS-CDR is a future-focused undergraduate programme designed to build strong technical foundations in programming, software development, database management, web technologies, cloud computing, cybersecurity, data analytics, and emerging fields like Artificial Intelligence. As one of the best BCA colleges in Ahilyanagar, we offer an AICTE-approved curriculum, affiliated with Savitribai Phule Pune University, blending classroom theory with hands-on labs, industry projects, and internships. Our readiness and practical approach in the BCA in Artificial Intelligence prepare students for careers as software developers, system analysts, data professionals, and IT consultants, while also building a strong foundation for higher studies and research in computing.
            </p>
          </div>
          <div className="overview_right">
            <div className="overview_rightinner">
              ...
              <div className="overview_right2">
                <span>Bachelor of Computer</span> Applications Programme
              </div>
            </div>
