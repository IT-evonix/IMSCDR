      ...
      <div className="programme_outcome_main">
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Scientific Knowledge</div>
            <p className="p-0 m-0">
              Apply the knowledge of mathematics, science fundamentals, and
              specialization to the solution of complex problems.
            </p>
          </div>
        </div>
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Problem analysis</div>
            <p className="p-0 m-0">
              Identify, formulate, review research literature, and analyze
              complex problems reaching substantiated conclusions using first
              principles of mathematics, natural sciences, and sciences.
            </p>
          </div>
        </div>
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Design/development of solutions</div>
            <p className="p-0 m-0">
              Design solutions for complex problems and design system components
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Modern tool usage</div>
            <p className="p-0 m-0">
              Create, select, and apply appropriate techniques, resources, and
              modern IT tools including prediction and modelling to complex
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">The Graduate and society</div>
            <p className="p-0 m-0">
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            ...
            <p className="p-0 m-0">
              Understand the impact of the professional solutions in societal
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Ethics</div>
            <p className="p-0 m-0">
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Individual and team work</div>
            <p className="p-0 m-0">
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            ...
            <p className="p-0 m-0">
              Communicate effectively on complex activities with the
              professional community and with society at large, such as, being
        ...
        <div className="programme_outcome_box">
          ...
          <div className="programme_outcome_right">
            <div className="subheading">Project management and finance</div>
            <p className="p-0 m-0">
              Demonstrate knowledge and understanding of the science and
