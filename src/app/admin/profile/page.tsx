          ...
          <form onSubmit={handleUpdatePassword} className="p-4 space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#1a1c20] cursor-pointer"
                >
            ...
            <div className="p-3 rounded-lg bg-[#f9f9ff] border border-[#1a1c20]/15 space-y-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 text-[11px]">
                <div className={`flex items-center gap-1.5 ${rules.minLength ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.hasUpper ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.hasLower ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.hasNumber ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.hasSpecial ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.noSpaces ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
                ...
                <div className={`flex items-center gap-1.5 ${rules.isDifferentFromOld ? 'text-green-600 font-semibold' : 'text-[#1a1c20]'}`}>
