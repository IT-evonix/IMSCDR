...
export default function AdminGrievancesPage() {
  ...
  const handleExportCsv = async () => {
    ...
    try {
      ...
      a.download = `IMSCDR_Grievance_Complaints_${today}.csv`;
      ...
      alert('Could not export grievances file. Please try again.');
    } finally {
    ...
    <div className="space-y-4">
      ...
      >
        ...
        >
          ...
          <span>{isExporting ? 'Exporting...' : 'Export Grievances'}</span>
        </button>
      </PageTitle>
      ...
      {/* Full Grievance Reader Modal (Same structure & classes as Contact Messages & Enquiries) */}
      {selectedGrievance && (
        <div
        ...
        >
          ...
          >
            ...
            <div className="p-4 space-y-3.5 max-h-[75vh] overflow-y-auto">
              ...
              {/* Complaint in Detail with Smooth Scroll */}
