    ...
    <div className="innerpage-wrapper">
      ...
      <div className="container">
        <div className="innerpagewrapper">
          ...
          <div className="fee_structure_main" style={{padding:"0px"}}>
            ...
            >
              ...
              <div className="fee_structure_heading">
                Fee Structure 2026 - 2027 (As per S.P. Pune University
                Circulars)
              </div>
            </div>
